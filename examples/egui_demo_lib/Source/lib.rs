...
Curabitur pretium tincidunt lacus. Nulla gravida orci a odio. Nullam varius, turpis et commodo \
	 ...
	 turpis, id tincidunt sapien risus a quam. Maecenas fermentum consequat mi. Donec fermentum. \
	 Pellentesque malesuada nulla a mi. Duis sapien sem, aliquet nec, commodo eget, consequat \
	 quis, neque. Aliquam faucibus, elit ut dictum aliquet, felis nisl adipiscing sapien, sed \
	 malesuada diam lacus eget erat. Cras mollis scelerisque nunc. Nullam arcu. Aliquam \
	 consequat. Curabitur augue lorem, dapibus quis, laoreet et, pretium ac, nisi. Aenean magna \
	 nisl, mollis quis, molestie eu, feugiat in, orci. In hac habitasse platea dictumst.";
...
fn test_egui_zero_window_size() {
	...
	for _ in 0..NUM_FRAMES {
		...
		let clipped_primitives = ctx.tessellate(full_output.shapes);
		assert!(clipped_primitives.is_empty(), "There should be nothing to show");
	}
}
